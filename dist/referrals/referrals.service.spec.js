...
describe('ReferralsService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                { provide: mail_service_1.MailService, useValue: mockMail },
                { provide: config_1.ConfigService, useValue: mockConfig },
            ],
        }).compile();
        service = module.get(referrals_service_1.ReferralsService);
        jest.clearAllMocks();
    });
    ...
    describe('convert', () => {
        it('should reject self-referral', async () => {
            ...
            await expect(service.convert({ code: 'ABC123', referredEmail: 'same@test.com' })).rejects.toThrow('You cannot refer yourself');
        });
        it('should reject duplicate email', async () => {
            ...
            await expect(service.convert({ code: 'ABC123', referredEmail: 'friend@test.com' })).rejects.toThrow('already been referred');
        });
        it('should reject duplicate ip within 24h', async () => {
            ...
            await expect(service.convert({ code: 'ABC123', referredEmail: 'friend@test.com', ipAddress: '127.0.0.1' })).rejects.toThrow('Duplicate referral detected from this device');
        });
...
//# sourceMappingURL=referrals.service.spec.js.map